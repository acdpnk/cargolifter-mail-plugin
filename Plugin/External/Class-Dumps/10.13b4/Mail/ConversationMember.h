...
@interface ConversationMember : NSObject <NSCopying>
{
    ...
    id _intelligentSuggestionsService;
}
...
@property(readonly, nonatomic) id intelligentSuggestionsService; // @synthesize intelligentSuggestionsService=_intelligentSuggestionsService;
- (void)invalidate;
