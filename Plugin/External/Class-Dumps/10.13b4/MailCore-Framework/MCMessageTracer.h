...
+ (void)messageTraceOperationError:(id)arg1 domainPrefix:(id)arg2 domainSuffix:(id)arg3 uuid:(id)arg4 duration:(double)arg5 count:(NSUInteger)arg6 size:(NSUInteger)arg7;
+ (void)messageTraceResult:(const char *)arg1 count:(NSUInteger)arg2 domainPrefix:(id)arg3 domainSuffix:(id)arg4 signature:(id)arg5 extraStatus:(id)arg6;
