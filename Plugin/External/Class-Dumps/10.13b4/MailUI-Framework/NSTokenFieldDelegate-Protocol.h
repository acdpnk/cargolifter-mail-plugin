...
- (NSArray *)tokenField:(NSTokenField *)arg1 shouldAddObjects:(NSArray *)arg2 atIndex:(NSUInteger)arg3;
- (NSUInteger)tokenField:(NSTokenField *)arg1 styleForRepresentedObject:(id)arg2;
