...
@class IMAPTaskManager, MCAuthScheme, MCError, MFIMAPOperationCache, MFLibraryIMAPStore, MFMailbox, NSArray, NSDictionary, NSLock, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString;
...
- (void)_expungeMailboxWithName:(id)arg1 URLToCompact:(id)arg2;
...
@property(readonly, nonatomic) BOOL hasOfflineActions;
