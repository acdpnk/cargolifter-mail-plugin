...
@class MFEWSAccount, NSArray, NSLock, NSMutableSet, NSString;
...
@property(readonly, copy, nonatomic) NSArray *incompleteMessages;
...
- (id)updateWithSyncState:(id)arg1 newMessages:(id)arg2 updatedMessages:(id)arg3 updatedLibraryIdStrings:(id)arg4 deletedMessages:(id)arg5 flagChanges:(id)arg6 isFinalBatch:(BOOL)arg7;
