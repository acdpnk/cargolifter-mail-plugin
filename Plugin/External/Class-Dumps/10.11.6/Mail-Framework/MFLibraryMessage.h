...
- (void)setRemoteID:(const char *)arg1 documentID:(id)arg2 flags:(long long)arg3 size:(NSUInteger)arg4 mailboxID:(long long)arg5 color:(char *)arg6 conversationID:(long long)arg7 conversationPosition:(int)arg8;
