...
@class MCError, MFCriterion, MFMailAccount, MFMessageCounts, MFMessageStore, NSArray, NSDictionary, NSEnumerator, NSImage, NSMutableIndexSet, NSMutableSet, NSOperationQueue, NSString, NSURL;
...
@property(readonly, nonatomic) BOOL isSmartMailboxExpressibleInTigerSchema;
...
- (id)objectSpecifier;
@property(readonly) MCError *openFailureError;
...
@property(readonly, nonatomic) long long smartMailboxEncodingVersion;
- (void)sortChildren;
