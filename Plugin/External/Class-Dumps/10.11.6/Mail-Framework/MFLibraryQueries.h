...
+ (id)fromClauseForTables:(NSUInteger)arg1 startingFromTableExpression:(id)arg2;
+ (char *)queryForUniquingDataForMessageNumber:(long long)arg1;
+ (char *)queryToDeleteEventByMessageID:(id)arg1;
+ (char *)queryToFindCopiesOfMessage:(char *)arg1 sentOn:(NSUInteger)arg2 receivedOn:(NSUInteger)arg3 withSize:(NSUInteger)arg4;
