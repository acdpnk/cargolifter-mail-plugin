...
@class ComposeBackEnd, MCActivityMonitor, MCError, MCMutableMessageHeaders, MCOutgoingMessage, NSArray;
...
- (void)backEnd:(ComposeBackEnd *)arg1 didCancelMessageDeliveryForEncryptionError:(MCError *)arg2;
- (void)backEnd:(ComposeBackEnd *)arg1 didCancelMessageDeliveryForError:(MCError *)arg2;
...
- (void)backEndSenderDidChange:(ComposeBackEnd *)arg1;
