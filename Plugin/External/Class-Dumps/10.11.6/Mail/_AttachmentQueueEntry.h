...
+ (id)newWithWindow:(id)arg1 attachment:(id)arg2 reason:(NSUInteger)arg3 opSpecific:(id)arg4 attachmentDirectory:(id)arg5;
+ (id)newWithWindow:(id)arg1 attachmentController:(id)arg2 reason:(NSUInteger)arg3 opSpecific:(id)arg4 attachmentDirectory:(id)arg5;
