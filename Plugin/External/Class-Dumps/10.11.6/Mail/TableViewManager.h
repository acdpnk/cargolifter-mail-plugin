...
@class ConversationPrefetcher, MCMessage, MFGlobalBodyFetchContext, MFMessageThread, MailTableView, MessageMall, MessageSelection, MessageViewer, NSArray, NSCache, NSDictionary, NSFont, NSMapTable, NSMutableArray, NSMutableAttributedString, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSTableColumn, NSTableHeaderView, TableViewScrollState;

@interface TableViewManager : NSObject <MailTableViewDelegate, NSTableViewDataSource, SelectionOwner>
{
...
+ (NSUInteger)_tableViewAnimationOptions:(NSUInteger)arg1;
+ (void)initialize;
...
- (void)_cacheSnippetsAroundRow:(NSUInteger)arg1;
...
- (NSUInteger)_indexOfMemberToSelectWhenOpeningThread:(id)arg1;
...
- (id)_messagesNeedingSnippetsAroundRow:(NSUInteger)arg1;
...
- (void)deleteMessages:(id)arg1 allowMoveToTrash:(BOOL)arg2 allowUndo:(BOOL)arg3 withAnimationOptions:(NSUInteger)arg4;
...
- (void)hideDeletions;
- (BOOL)hideMessages:(id)arg1 selectingNextMessage:(BOOL)arg2 withAnimationOptions:(NSUInteger)arg3;
...
@property(readonly, nonatomic) BOOL isSortedChronologically;
