...
#import "MailInspectorBarClient-Protocol.h"

@class DOMHTMLAnchorElement, DOMHTMLElement, DOMNode, NSOperationQueue, NSString, NSURL;

@interface EditingMessageWebView : TilingWebView <NSFilePresenter, MailInspectorBarClient, NSTextInputClient>
{
