...
#import "MUIAddressTokenAttachmentDelegate-Protocol.h"
...
- (id)layoutManager:(id)arg1 shouldUseSelectedTextAttributes:(id)arg2 atCharacterIndex:(NSUInteger)arg3 effectiveRange:(struct _NSRange *)arg4;
