...
@class MUISenderPhotoView, NSAttributedString, NSColor, NSImageView, NSLayoutConstraint, NSMutableArray, NSStackView, NSTextField, ThreadDisclosureTextField, _ToCCIndicator;
