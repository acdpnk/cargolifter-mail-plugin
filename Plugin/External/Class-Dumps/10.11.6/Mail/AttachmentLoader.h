...
+ (id)loaderForAttachment:(id)arg1 window:(id)arg2 reason:(NSUInteger)arg3 application:(id)arg4 attachmentDirectory:(id)arg5;
+ (id)loaderForAttachmentViewController:(id)arg1 window:(id)arg2 reason:(NSUInteger)arg3 application:(id)arg4 attachmentDirectory:(id)arg5;
