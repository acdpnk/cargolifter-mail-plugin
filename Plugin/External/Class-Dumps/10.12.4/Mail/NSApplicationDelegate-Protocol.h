...
- (NSUInteger)application:(NSApplication *)arg1 printFiles:(NSArray *)arg2 withSettings:(NSDictionary *)arg3 showPrintPanels:(BOOL)arg4;
...
- (NSUInteger)applicationShouldTerminate:(NSApplication *)arg1;
