...
@interface ComposeViewController (Compatibility1013)
- (NSWindow*) window;
@end

@interface MCAttachment (Compatibility1013)
- (id)fileWrapperForAccessLevel:(long long)arg1;
@end

@interface HeadersEditor (Compatibility1013)
